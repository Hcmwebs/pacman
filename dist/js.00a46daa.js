...
var CLASS_LIST = [OBJECT_TYPE.BLANK, OBJECT_TYPE.WALL, OBJECT_TYPE.DOT, OBJECT_TYPE.BLINKY, OBJECT_TYPE.PINKY, OBJECT_TYPE.INKY, OBJECT_TYPE.CLYDE, OBJECT_TYPE.PELLET, OBJECT_TYPE.PACMAN, OBJECT_TYPE.GHOSTLAIR]; // prettier-ignore
...
exports.LEVEL = LEVEL;
},{}],"js/ghostsMoves.js":[function(require,module,exports) {
"use strict";
...
function randomMovement(position, direction, objectExists) {
  ...
  while (objectExists(nextMovePos, _setup.OBJECT_TYPE.WALL) || objectExists(nextMovePos, _setup.OBJECT_TYPE.GHOST)) {
    ...
    dir = _setup.DIRECTIONS[key]; //Set the nextMove
...
var GameBoard = /*#__PURE__*/function () {
  function GameBoard(DOMGrid) {
    ...
    (0, _defineProperty2.default)(this, "objectExists", function (pos, object) {
...
var POWER_PELLET_TIME = 10000; //ms

var GLOBAL_SPEED = 80; //ms

var gameBoard = _GameBoard.default.createGameBoard(gameGrid, _setup.LEVEL); //functions
//Audio
    ...
    if (pacman.powerPellet) {
      ...
      ghosts.forEach(function (ghost, i) {
        if (collidedGhost.name === ghost.name) {
          gameBoard.removeObject(ghost.pos, [_setup.OBJECT_TYPE.GHOST, _setup.OBJECT_TYPE.SCARED, ghost.name]); //Reset the ghost to the start position
...
var gameLoop = function gameLoop(pacman, ghosts) {
  ...
  if (gameBoard.objectExists(pacman.pos, _setup.OBJECT_TYPE.PELLET)) {
    playAudio(_pill.default);
    gameBoard.removeObject(pacman.pos, [_setup.OBJECT_TYPE.PELLET]);
    pacman.powerPellet = true;
    score += 50;
    clearTimeout(powerPelletTimer);
    powerPelletTimer = setTimeout(function () {
      return pacman.powerPellet = false;
    }, POWER_PELLET_TIME);
  ...
  if (pacman.powerPellet != powerPelletActive) {
    ...
    ghosts.forEach(function (ghost) {
      return ghost.isScared = pacman.powerPellet;
    });
